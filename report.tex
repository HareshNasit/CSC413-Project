...
Style transfer is a vision related problem where the style mapping domain X is learned and applied to another domain Y. Since finding paired data is hard, we train the model on combined domains to give a shared latent representation and train the decoders separately based on specific domains. In this paper, show a method that can learn the features of one domain such as the   
\end{abstract}
